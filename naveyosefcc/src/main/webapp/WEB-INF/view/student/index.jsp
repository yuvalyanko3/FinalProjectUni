...
<body style="background-image: url('/images/bacg.png'); background-size: 100% auto; background-repeat: no-repeat; margin-top: -50px;" class="mh-100 min-vh-100">
<nav class="navbar navbar-dark bg-dark navbar-expand-md fixed-top" style="display: grid; grid-template-columns: 1fr 1fr 6fr 1fr 1fr 1fr 1fr; background-color: #6c757d; height: 70px;">
    ...
    <a id="hourReport" class="navbar-brand" style="font-size: 16px; margin-right: 18px; grid-area: 1 / 6 / 2 / 7; text-align: right;" data-toggle="modal" href="#hoursReporting" >דיווח שעות</a>
...
<span id="teacher-id" value="${teacherId}"></span>
    ...
    <div id="nextLessons">
        <table class="table table-sm text-center" style="  margin-bottom: 0px;  " id="nextLessonsTable">
            ...
            <tr>
                ...
                <td style="vertical-align: baseline;" id="thTw">
                ...
                <td style="vertical-align: baseline;" id="weTw">
                    <c:forEach items="${nextLessons}" var="nextLesson">
                ...
                <td style="vertical-align: baseline;" id="tuTw">
                    <c:forEach items="${nextLessons}" var="nextLesson">
                ...
                <td style="vertical-align: baseline;" id="moTw">
                    <c:forEach items="${nextLessons}" var="nextLesson">
                ...
                <td style="vertical-align: baseline;" id="suTw">
                    <c:forEach items="${nextLessons}" var="nextLesson">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 14px; padding: 30px;" id="lessonsDiv">
                <div class="scrollbar scrollbar-primary" dir="rtl" style=" height: 350px; overflow: auto; display: block;">
                    <table class="table text-center" dir="ltr" style=" border: 2px solid #dee2e6; margin-bottom: 0px; background-color: #FCFCFC; box-shadow: 2px 2px 10px -5px #dedede;" id="lessonsTable">
                        <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 10px; border-left: 2px solid #dee2e6;">שיעור</th>
                        </tr>
                        </thead>
...
<%--                                <option value="0" style="display: none;">0</option>--%>
            ...
            <div dir="rtl" class="modal-footer" style="background-color: #3b3f44; ">
                <button type="button" data-dismiss="modal" class="close" style="margin-left: auto; color: #ffffff; font-size: 16px; font-weight: lighter; opacity: 100%;" onclick="clearForm('lesson')"  >  סגירה ללא שמירה</button>
...
<!-------------------------------------------------- HOURS REPORTING MODAL --------------------------------------------------------------->
<form id="hourForm" action="/student/addHourReport" method="post">
    <div id="hoursReporting" class="modal pg-show-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalPopoversLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
        <div class="text-right modal-lg modal-dialog modal-dialog-centered carousel-fade" role="document" style="max-width: 1000px!important;">
            <div class="modal-content">
                <div class="modal-header text-right text-xl-right text-lg-right text-md-right text-sm-right" style="text-align: right; background-color: #fafafa;">

                    <h5 class="modal-title" style="text-align: right; padding-right: 5px; margin-right: 7px; margin-left: auto; font-size: 22px; color: #565f66; font-family: Heebo; "><label style="font-size:14px">חודש <span id="month"></span>&nbsp&nbsp&nbsp</label>דיווח שעות התנדבות
                        <i class="fa-clock-o fa" style="color: #bfc8cf; margin-left: 10px; font-size: 18px;"></i></h5>

                </div>
                <div class="modal-body" style="font-size: 14px; padding: 30px;" >
                    <div class="scrollbar scrollbar-primary" dir="rtl" style=" height: 280px; overflow: auto; display: block;">
                        <table class="table text-center" dir="ltr" style=" border: 1px solid #dee2e6; margin-bottom: 0px; background-color: #FCFCFC; " >
                            <thead>
                            <tr>
                                <th style="border-left: 1px solid #dee2e6;">מחיקה</th>
                                <th style="border-left: 1px solid #dee2e6; width: 400px;">תיאור הפעילות</th>
                                <th style="border-left: 1px solid #dee2e6;">עד שעה</th>
                                <th style="border-left: 1px solid #dee2e6;">משעה</th>
                                <th class="text-center" style="border-left: 1px solid #dee2e6;">תאריך</th>
                            </tr>
                            </thead>
                            <tbody style="text-align: center; margin-top: -10px;" id="actBody">
                    ...
                    <label style="padding-left: 7px; padding-bottom: 10px; font-weight: bold; font-size: 18px;">הוספת / עריכת דיווח</label>
                    <table class="table text-center" dir="ltr" style=" border: 2px solid #dee2e6; margin-bottom: 0px; background-color: #FCFCFC; box-shadow: 2px 2px 10px -5px #dedede;" >
                        <thead>
                        <tr>
                            <th style="border-left: 2px solid #dce0e4; background-color: #f7f7f7;">תיאור הפעילות</th>
                            <th style="border-left: 2px solid #dee2e6; background-color: #f7f7f7;">עד שעה</th>
                            <th style="border-left: 2px solid #dee2e6; background-color: #f7f7f7;">משעה</th>
                            <th style="border-left: 2px solid #dee2e6; background-color: #f7f7f7;">תאריך</th>
                        </tr>
                        </thead>
                        <tbody style="text-align: center;">
                        <tr >
                            <td style="border-left: 2px solid #dee2e6; width: 450px;"><input type="text" name="activDesc" class="form-control text-right" id="activDesc" placeholder="תיאור הפעילות בקצרה"/></td>
                            <td style="border-left: 2px solid #dee2e6;" ><input type="time" class="form-control" id="activEnd" placeholder="" name="endTime" min="14:00:00" max="19:00:00"></td>
                            <td style="border-left: 2px solid #dee2e6;" ><input type="time" class="form-control" id="activStart" placeholder="" name="startTime" min="14:00:00" max="19:00:00"></td>
                            <td style="border-left: 2px solid #dee2e6; " ><input type="date" name="activDate" class="form-control" id="activDate" /></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                <div dir="rtl" class="modal-footer" style="background-color: #3b3f44;">
                    <button type="button" data-dismiss="modal" class="close" style="margin-left: auto; color: #ffffff; font-size: 16px; font-weight: lighter; opacity: 100%;" onclick="clearForm('hour')">סגירה ללא שמירה</button>
                    <input id="hourSubmit" type="submit"  class="btn btn-secondary" value="שמירה" style="border-radius: 100px; width: 90px;"/>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready ( function () {
        $(document).on ("click", ".fa-trash-o", function (e) {
            ...
            let formData = {};
            formData["date"] = $(this).attr("name");
            $.ajax({
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                },
                url: '/student/removeHourReport',
                type: 'post',
                dataType: 'json',
    ...
    $("#hourForm").on('submit', function (e) {
        ...
        if(!validHourForm())
        {
            $("#hourError").html("ערכים לא תקינים");
            e.preventDefault();
            return;
        }
    ...
    function validHourForm() {
        let toReturn = true;
        if(!validateActivityDate($("#activDate").val()))
        {
            toReturn = false;
        }
        let startTime = $("#activStart").val();
        let endTime = $("#activEnd").val();
        if(!validateDayTime(startTime, endTime))
        {
            toReturn = false;
        }
        return toReturn;
    ...
    $("#hourReport").on('click', function (e) {
        $("#month").html(setMonth(new Date().getMonth()));
        setHourReport(e);
    });
    
    function setHourReport(e) {
        let sId = $("#teacher-id").attr('value');
        let formData = {};
        formData['sId'] = sId;
        e.preventDefault();
        $.ajax({
            ...
            url: '/student/monthlyActivities',
            type: 'post',
            dataType: 'json',
            data: JSON.stringify(formData),
            success: function (response) {
                populateStudentActivities(response);
                clearForm("hour");
            },
            error: function(jqXHR, textStatus, errorThrown){
            }
    ...
    function populateStudentActivities(response) {
        let toAppend = "";
        $("#actBody").html(toAppend);
        $.each(response, function (ind, val) {
            toAppend += '<tr>';
            toAppend += '<td style="border-left: 1px solid #dee2e6;" id="hoursrow1"><a class="btn updateModal" role="button" style="border-radius: 100px; font-size: 18px; padding: 3px 8px; " target="_self" name=""><i name=' + val['actDate'] + ' class="fa fa-trash-o" style="color: #24292e;"></i></a></td>';
            toAppend += '<td style="border-left: 1px solid #dee2e6;" id="hoursrow2">' + val['actDesc'] + '</td>';
            toAppend += '<td style="border-left: 1px solid #dee2e6;" id="hoursrow3">' + val['finishHour'] + '</td>';
            toAppend += '<td style="border-left: 1px solid #dee2e6;" id="hoursrow4">' + val['startHour'] + '</td>';
            toAppend += '<td style="border-left: 1px solid #dee2e6;" id="hoursrow5">' + val['actDate'] + '</td>';
            toAppend += '</tr>';
        });
        $("#actBody").append(toAppend);
    }
    ...
    function isValid() {
        ...
        // if($("#lessonGrade").val() == "def")
        // {
        //     toReturn = false;
        //     $("#lessonGradeError").html("יש לבחור ציון");
        //     $("#lessonGrade").val("0");
        // }
        // if($("#lessonDesc").val() == "")
        //     toReturn = false;
    ...
    $("#passForm").on('submit', function (e) {
        ...
        if(!isPassFormValid(id, newPass, repeatPass, true))
        {
            e.preventDefault();
            return false;
        }
    ...
    function changePassword(id, newPass, repeatPass, idRequired) {
    ...
    function populateChart(idTeacher, idPupil) {
        $.ajax({
            ...
            url: "/student/getChartData?idT=" + idTeacher + "&idP=" + idPupil,
            type: 'GET',
            success: function (response) {
                setChart(response);
            },
